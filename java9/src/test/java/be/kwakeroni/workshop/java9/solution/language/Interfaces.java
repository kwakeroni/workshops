...
public class Interfaces {
    ...
    public interface Registry<T> {
        ...
        private <V> Map<Long, V> byId(Collection<T> collection, Function<T, V> valueMapper) {
        ...
        private static <T, K, V> Map<K, V> by(Function<T, K> keyMapper, Function<T, V> valueMapper, Collection<T> collection) {
