...
public class StreamTest {
    ...
    private BigInteger getFermatNumber(int index) {
        int pow2i = TWO.pow(index).intValueExact();
        BigInteger pow2pow2i = TWO.pow(pow2i);
    ...
    public void testMapMulti() {
        List<String> l = this.mapFizzBuzzStream(IntStream.rangeClosed(1, 20).boxed()).collect(Collectors.toList());
