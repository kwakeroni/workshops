...
public class OptionalTest {
    ...
    private int calculateAmountInEuro(String currency, int currencyAmount) {
        ExchangeRate exchangeRate = getExchangeRate(currency).orElseThrow();
    ...
    private void logExchangeRate(String currency) {
        getExchangeRate(currency).ifPresentOrElse(
                exchangeRate -> logger.info("Applying exchangeRate={} for currency={}", exchangeRate.rate(), currency),
    ...
    private Optional<ExchangeRate> getExchangeRate(String currency) {
        return ibanFirst.getExchangeRate(currency)
                .or(() -> wubs.getExchangeRate(currency))
                .or(() -> ibs6Fallback.getExchangeRate(currency));
    }
    ...
    public void testGetExchangeRateFromIbanFirst() {
        ...
        assertThat(getExchangeRate("EUR").orElseThrow().rate()).isEqualTo(1);
    }
    ...
    public void testGetExchangeRateFromWubs() {
        ...
        assertThat(getExchangeRate("EUR").orElseThrow().rate()).isEqualTo(2);
    }
    ...
    public void testGetExchangeRateFromIBS6() {
        ...
        assertThat(getExchangeRate("EUR").orElseThrow().rate()).isEqualTo(3);
    }
